...
int main()
{
    ...
    std::cout << "integers : ";
    print(integers);
    std::ranges::filter_view v_evens1 = std::views::filter(integers, evens1); // No computation
    std::cout << "integers evens : ";
    print(v_evens1); // Computation happens in the print function
    // Print evens on the fly
    std::cout << "vi evens : ";
    print(std::views::filter(integers, evens1));
    // Print odds on the fly
    std::cout << "vi odds : ";
    print(std::views::filter(integers, [](int i)
                             { return (i % 2) != 0; }));
