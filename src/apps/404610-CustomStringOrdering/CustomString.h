...
class string{
    ...
    //This is our operator== . The compiler will use it to generate operator!=
    //We're not defaulting operator== because default member wise comparison would 
   // just compare pointers in m_data and not actual string data.
