...
class TemplateClass
{
    ...
    // friend void some_func<>(TemplateClass<T> param);     // This will also work; note <> instead of <T>
    // friend void some_func(TemplateClass<T> param);       // But this will not work, here no <> is present.
