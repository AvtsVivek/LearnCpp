...
int main()
{
    ...
    std::pair<int, const char *> pair3 = std::make_pair(3, "Chair"); // Deduces the template arguments

    std::pair<int, std::string> pair4 = std::make_pair(4, "Teapoy");

    // std::cout << "pair1 : " << pair1 << std::endl; // Compiler error.
    ...
    std::vector<std::pair<int, std::string>> collection{{10, "Earth"}, {20, "Spins"}, {30, "From"}, {40, "Left"}, {50, "To"}, {60, "Right"}};
    // Traverse : syntax1
    std::cout << std::endl;
