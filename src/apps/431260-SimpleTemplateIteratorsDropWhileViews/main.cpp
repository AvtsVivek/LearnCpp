...
int main()
{
    ...
    std::ranges::drop_while_view v_drop_while = std::ranges::drop_while_view(integers, [](int i)
                                                                             { return (i % 2) != 0; });
    std::cout << "integers : ";
    print(integers);
    ...
    std::ranges::drop_while_view v_drop_while_one = std::ranges::drop_while_view(integers, [](int i)
                                                                                 { return i != 8; });
