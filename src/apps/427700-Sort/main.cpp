...
int main()
{
    ...
    // The following list, if used instead of the above vercot, will give compiler errors. 
    // Comment the above and uncomment the following and see the errors.
    // std::list<int> collection = {5, 7, 4, 2, 8, 6, 1, 9, 0, 3};
