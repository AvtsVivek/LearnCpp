...
g++ -fmodules-ts main.cpp math.o math_impl.o print_impl.o -o main.exe
...
clang++ -std=c++20 math_impl.cpp -fmodule-file=math_stuff=math_stuff.pcm -c -o math_impl.o

clang++ -std=c++20 -fmodule-file=iostream.pcm print_impl.cpp -fmodule-file=math_stuff=math_stuff.pcm -c -o print_impl.o
...
clang++ -std=c++20 main.o math_stuff.o  math_impl.o print_impl.o -o main.exe
...
clang++ -std=c++23 math_impl.cpp -fmodule-file=math_stuff=math_stuff.pcm -c -o math_impl.o
clang++ -std=c++23 -fmodule-file=iostream.pcm print_impl.cpp -fmodule-file=math_stuff=math_stuff.pcm -c -o print_impl.o
...
clang++ -std=c++23 main.o math_stuff.o  math_impl.o print_impl.o -o main.exe
